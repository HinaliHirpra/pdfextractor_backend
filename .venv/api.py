...
2. Identify and extract **product features** as bullet points or key-value pairs and Do not include **tables** (structured as list of lists).
3. Identify and extract any **tables** (structured as list of lists).
4. Identify paragraphs or **descriptive text** and Do not include **tables** (structured as list of lists).
5. Capture any **other product-related info** (specs, usage, etc.) and Do not include **tables** (structured as list of lists).
...
def merge_data(chunks_data):
    merged = {"product": None, "features": [], "tables": [], "descriptions": [], "others": []}
